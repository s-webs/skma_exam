...
return [
    'title' => 'Выписка из ведомости специального экзамена в форме психометрического тестирования',
    'based_on' => 'ID :id от :date г.',
    'full_name' => 'ФИО',
    'exam_result' => 'Результат экзамена',
    'exam' => 'Экзамен',
    'exam_type_and_name' => 'Тип экзамена / Язык сдачи',
    'correct_answers' => 'Верных ответов',
    'total_score' => 'Итоговый балл',
    'passing_threshold' => 'Порог для зачёта',
    'subject' => 'Предмет',
    'points' => 'Баллы',
    'result' => 'Итог',
    'passed' => 'Допуск',
