...
export default function Applicants({ exam, registrations, rows }: ApplicantsProps) {
    ...
    const reviewUrl = (registrationId: number) =>
        `${route('admin.exam-registrations.review', registrationId)}?source=exam`;
    ...
    return (
        <AppLayout>
            <Head title={`Попытки - ${exam.name_ru}`} />
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div className="mb-6">
                        <h2 className="text-3xl font-bold tracking-tight">{exam.name_ru}</h2>
                        ...
                        <CardContent>
                            <Table>
                                ...
                                <TableBody>
                                    {rows.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={showCheckboxColumn && checkableIds.length > 0 ? 7 : 6} className="text-center text-muted-foreground">
